...
Upgrade from any 1.x or 2.0.x image the same way as a patch: pull `:latest` or `2.0.6`, restart, let migrations run. [Release notes](https://github.com/lqdflying/chathub/releases/tag/v2.0.6) · [Wiki](https://github.com/lqdflying/chathub/wiki)
