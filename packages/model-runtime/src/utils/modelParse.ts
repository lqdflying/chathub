...
export const MODEL_LIST_CONFIGS = {
  ...
  mimo: {
    ...
    functionCallKeywords: ['mimo-v2.5', 'mimo-v2.6'],
    reasoningKeywords: ['mimo-v2.5', 'mimo-v2.6'],
    videoKeywords: ['mimo-v2.6', 'mimo-v2.5', '!mimo-v2.5-pro'],
    visionKeywords: ['mimo-v2.6', 'mimo-v2.5', '!mimo-v2.5-pro'],
  },
  minimax: {
    functionCallKeywords: ['minimax', 'm3'],
    reasoningKeywords: ['-m', 'm3'],
    videoKeywords: ['m3'],
  ...
  zhipu: {
    functionCallKeywords: ['glm-4', 'glm-z1', 'glm-4.5', 'glm-4.6', 'glm-4.7', 'glm-5'],
    reasoningKeywords: ['glm-zero', 'glm-z1', 'glm-4.5', 'glm-4.6', 'glm-4.7', 'glm-5', 'glm-5v'],
