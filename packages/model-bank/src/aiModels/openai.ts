...
export const openaiChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.2 Pro uses more computation to think deeper and consistently delivers better answers.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description:
      'GPT-5.2 achieves further improvements in accuracy, speed, and reasoning, making it a powerful choice for cross-domain coding and agentic tasks.',
    displayName: 'GPT-5.2',
    enabled: true,
    id: 'gpt-5.2',
    maxOutput: 128_000,
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'The GPT-5.2 model used in ChatGPT, combining powerful language understanding and generation capabilities.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.2 Codex is a version of GPT-5.2 optimized for agentic coding tasks.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.3 Codex is the latest generation model optimized for agentic coding tasks.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description:
      'GPT-5.1 improves upon GPT-5 in accuracy and reasoning, making it the preferred model for cross-domain tasks.',
    displayName: 'GPT-5.1',
    enabled: true,
    id: 'gpt-5.1',
    maxOutput: 128_000,
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'The GPT-5.1 model used in ChatGPT, combining powerful language understanding and generation capabilities.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description: 'GPT-5.1 Codex is a version of GPT-5.1 optimized for agentic coding tasks.',
  ...
  },
  {
    ...
    contextWindowTokens: 128_000,
    description:
      'GPT Audio Mini is a lightweight audio chat model supporting cost-effective text and audio input/output.',
...
export const openaiImageModels: AIImageModelCard[] = [
  {
    description: 'Enhanced version of the ChatGPT native multimodal image generation model, offering higher image quality and detail.',
...
export const openaiRealtimeModels: AIRealtimeModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 32_000,
    description: 'Next-generation general realtime model supporting real-time text and audio input/output with image input support.',
  ...
  {
    contextWindowTokens: 128_000,
    description: 'Lightweight realtime model supporting cost-effective real-time audio and text input/output.',
