...
/** Xiaomi MiMo extended options (thinking on/off). */
const MimoOptions = memo(() => {
    ...
    items.push({
      ...
      desc: (
        <span style={isNarrow ? descNarrow : descWide}>
          {t('extendParams.mimoReasoning.desc')}
        </span>
      ),
      label: t('extendParams.mimoReasoning.title'),
...
MimoOptions.displayName = 'MimoOptions';

export default MimoOptions;
