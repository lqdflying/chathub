...
const MoonshotOptions = memo(() => {
  ...
  if (extendParams.includes('enableReasoning')) {
    items.push({
      children: <Switch />,
      desc: (
        <span style={isNarrow ? descNarrow : descWide}>{t('extendParams.kimiReasoning.desc')}</span>
      ),
      label: t('extendParams.kimiReasoning.title'),
...
MoonshotOptions.displayName = 'MoonshotOptions';

export default MoonshotOptions;
