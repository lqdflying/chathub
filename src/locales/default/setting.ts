export default {
  ...
  danger: {
    clear: {
      ...
      confirm: '清除所有话题和消息？',
      confirmDesc:
        '此操作仅删除默认话题、普通助手和群聊中的所有话题及消息，且无法撤销。助手及其角色设定、会话设置、文件、插件和群组定义将保留。',
      desc: '删除默认话题、普通助手和群聊中的所有话题及消息。助手及其角色设定和其他配置将保留。',
      success: '已清除所有话题和消息',
      title: '清除所有话题',
    },
    reset: {
  ...
  settingCommon: {
    generalInstruction: {
      desc: '此指令会合并到普通助手和群聊成员的角色设定中，不会应用于主持人或内部自动化任务。',
