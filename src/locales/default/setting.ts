export default {
  ...
  settingChatMemory: {
    ...
    dynamicMemory: {
      ...
      hint: '每次成功的记忆梦境会追加一张带 UTC 日期标签的卡片（#1、#2…），内容来自该 UTC 日活跃话题的压缩摘要。可逐条编辑、删除；单日卡片可针对该 UTC 日重新生成。超出保留条数的较早卡片会在梦境运行时被重新汇总进一条最多 6400 字的范围卡片。',
    ...
    enableUserMemoryArchive: {
      ...
      title: '话题记忆片段',
      tooltip:
        '在各话题元数据中保存简短摘要片段供模型复用。需在「对话偏好」中开启限制历史消息数与历史总结后，压缩摘要才会参与记忆梦境。',
    },
    fixedMemory: {
      addEntry: '添加记忆',
