export default {
  ...
  settingChatMemory: {
    ...
    export: '导出 Markdown',
    fixedMemory: {
      hint: '仅由你维护的持久内容（Markdown），注入与该助手的每次对话；自动汇总永远不会修改或覆盖它。',
      placeholder: '记录希望助手永远记住的信息：偏好、规则、项目背景…',
      title: '固定记忆（用户维护）',
    },
    guide:
      '1）「固定记忆」由你维护、永不被自动修改；「动态记忆」由模型从话题压缩摘要增量提炼，可随时编辑、重新生成或恢复上一版。\n2）话题压缩需先在「聊天偏好」开启「限制历史消息数」与「历史总结」。\n3）聊天中点击绿色「用量」标签可查看各部分占用并手动压缩。',
    guideTitle: '设置步骤',
    memoryGroupTitle: '记忆',
