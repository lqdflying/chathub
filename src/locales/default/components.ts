export default {
  ...
  FileManager: {
    actions: {
      ...
      confirmMarkItDown: '将使用 MarkItDown 重新解析该文件并替换现有分块，请确认你的操作',
      confirmReParseChunks: '将重新解析该文件并替换现有分块，请确认你的操作',
      ...
      downloading: '文件下载中...',
      markitdown: 'MarkItDown 解析',
      markitdownTooltip: '使用 MarkItDown 转换并查看分块内容',
      reParseChunks: '重新解析分块',
