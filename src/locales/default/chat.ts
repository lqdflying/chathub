export default {
  ...
  extendParams: {
    ...
    xaiReasoningEffort: {
      desc: 'Grok 4.6：low / medium / high / xhigh（无法关闭思考）。Grok 4.5：low / medium / high。Grok 4.3：none / low / medium / high。',
      title: '推理强度（Grok）',
    },
    ...
    zhipuReasoningEffort: {
      desc: '仅 GLM-5.2 支持 Skip。max=深度思考（默认），high=增强思考，skip=跳过思考（映射到 API 的 none）。仅在思考开启时生效。',
      desc53:
        'GLM-5.3 / GLM-5.3-Flash 无法关闭思考。low=轻度，high=增强，max=深度（默认）。其他值会被接口拒绝。',
      high: 'High',
      low: 'Low',
      max: 'Max',
      skip: 'Skip',
  ...
  tokenDetails: {
    ...
    cacheCached: '已缓存',
    cacheCaption:
      '来自本话题最近一次上报了缓存字段的回复。之后若有回复没有缓存数据，不会替换这里的数字。不是上方的下次请求估算。',
    cacheEmpty: '尚无提供方缓存数据',
    cacheHitRate: '{{percent}}% 命中',
    cacheRatio: '{{cached}} / {{input}}',
    cacheSource: '来自 {{model}}',
    cacheStatusNoHit: '尚未命中',
    cacheStatusReported: '提供方已上报',
    cacheStatusWorking: '已命中',
    cacheTitle: '最近上报的缓存',
    cacheUncached: '未缓存',
    ...
    historySummary: '历史总结',
    historyWindow: {
      compactionStatus: '最近压缩',
      excludedByCursor: '已由总结覆盖',
