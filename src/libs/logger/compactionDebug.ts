...
const plannerSettledFieldsSchema = z
  .object({
    ...
    effectiveHistoryCount: optionalFiniteNumber,
    ...
    excludedByCursor: optionalFiniteNumber,
    excludedByHistoryCount: optionalFiniteNumber,
    ...
    preSendMessageCountCompact: optionalBoolean,
